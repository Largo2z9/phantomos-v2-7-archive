...
**Sub-doctrines (read when authoring or extending):** Contextual Intelligence is the master doctrine. 23 canon doctrines shipped serve it (canon Sprint A inventory + v2.79.2 output-clarity + v2.79.3 onboarding-holistic + engagement-disclosure additions + v2.80.0 update-distribution-discipline) :
