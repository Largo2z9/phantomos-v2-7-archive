...
Disclosure rendu respecte iconographie canon `output-clarity-discipline.md` v2.79.2 strict ·
...
Plan disclosure max 6-8 étapes cap strict. Headers courts FR sobres cohérent `output-clarity-discipline.md` HR-OCD-3. Verbalisation opérateur-facing canon (zéro jargon interne · zéro skill names · zéro field paths). Violation = bug invalid pattern canon (overload cognitif opérateur).
