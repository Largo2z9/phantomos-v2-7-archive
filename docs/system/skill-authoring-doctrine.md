...
- **`brand-isolation-doctrine.md`** · doctrine isolation v2.37+. Frontmatter `isolation_scope` enum [brand_only, cross_brand_with_gate, workspace_global]. Default `brand_only` enforced. Empêche cross-contamination multi-brand (red team finding A7).
