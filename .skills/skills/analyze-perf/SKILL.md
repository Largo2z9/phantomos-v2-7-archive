...
- **`skill-routing-discipline.md`** · NEVER prose-improvise downstream from an analyze-perf diagnostic. Lever validated by operator → invoke the corresponding skill via Task tool (`produce-paid-angles`, `compose-creative`, `recompose-creative`, `scaffold-extension`, `audit-meta-account`).
