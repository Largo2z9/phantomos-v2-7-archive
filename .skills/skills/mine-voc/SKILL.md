...
Cross-ref doctrines · `docs/system/decomposition-visibility-doctrine.md` v2.79.5+ (NIVEAU 0 pré-exec) + `docs/system/engagement-disclosure-discipline.md` v2.79.5 (Paramètres décomposés section).
